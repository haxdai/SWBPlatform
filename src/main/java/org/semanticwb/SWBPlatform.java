...
public class SWBPlatform {
    ...
    private static SWBSecurityInstanceValues secValues = new SWBSecurityInstanceValues(null);
     ...
     * The admin file.
     */
    //TODO: Move property and methods out of SWBPlatform
     ...
     */
    public static final String PRESIST_TYPE_DEFAULT = "default";

    /**
     * The Constant PRESIST_TYPE_SDB.
     */
    public static final String PRESIST_TYPE_SDB = "sdb";

    /**
     * The Constant PRESIST_TYPE_TDB.
     */
    public static final String PRESIST_TYPE_TDB = "tdb";

    /**
     * The Constant PRESIST_TYPE_TDB.
     */
    public static final String PRESIST_TYPE_BIGDATA = "bigdata";

    /**
     * The Constant PRESIST_TYPE_REMOTEPLATFORM.
     */
    public static final String PRESIST_TYPE_SWBREMOTETRIPLESTORE = "swbrts";

    /**
     * The Constant PRESIST_TYPE_TDB.
     */
    public static final String PRESIST_TYPE_SWBTRIPLESTORE = "swbts";

    /**
     * The Constant PRESIST_TYPE_TDB.
     */
    public static final String PRESIST_TYPE_SWBTRIPLESTOREEXT = "swbtse";

    public static final String PRESIST_TYPE_SWBTSMONGO = "swbtsmongo";

    public static final String PRESIST_TYPE_SWBTSMONGOE = "swbtsmongoe";

    public static final String PRESIST_TYPE_VIRTUOSO = "virtuoso";

    public static final String PRESIST_TYPE_SWBTSGEN = "swbtsg";

    public static final String PRESIST_TYPE_SWBTSGEMFIRE = "swbtsgemfire";
     ...
     * The semantic mgr.
     */
    private static SemanticMgr semanticMgr = new SemanticMgr();

    /**
     * The Constant version.
     */
    protected static final String version = "5.0.1.0";
     ...
     * @return Valor de la variable de ambiente
     */
     ...
     *
     * @param name   String nombre de la variable
     * @param def String valor por defecto
     * @return
     */
    public static String getEnv(String name, String def) {
        String obj = System.getProperty("swb.web." + name);
        if (obj != null) {
            return obj;
        }
        if (props != null) {
    ...
    public void writeFileToPlatformWorkPath(String path, InputStream in) throws SWBException {
        //TODO:Implementar Replicacion de archivos
        try {
    ...
    public String readFileFromPlatformWorkPath(String path) throws IOException, SWBException {
        return SWBUtils.IO.getStringFromInputStream(getFileFromPlatformWorkPath(path));
    }
    ...
    public static class JENA_UTIL {
        ...
        public static String getTextLocaled(Resource res, Property label) {
            ...
            while (it.hasNext()) {
                ...
                ret.append(st.getString());
                if (st.getLanguage() != null) {
                    ret.append("(").append(st.getLanguage()).append(")");
                }
                if (it.hasNext()) {
                    ret.append(", ");
                }
        ...
        public static String getId(Resource res) {
            ...
            StringBuilder ret = new StringBuilder();
            ret.append(res.getModel().getNsURIPrefix(res.getNameSpace()))
                    .append(":")
                    .append(res.getLocalName());
        ...
        public static String getObjectLink(Resource res, Property ptype, Model model, String text, String pathView) {
            String val = text;
            if (val == null) {
                val = getObjectId(res, ptype, model);
            }
            Statement stm = res.getProperty(ptype);
            if (stm != null) {
    ...
    public static boolean isTDB() {
        return persistenceType.equals(PRESIST_TYPE_TDB);
    }
    ...
    public static boolean isBigdata() {
        return persistenceType.equals(PRESIST_TYPE_BIGDATA);
    }
    ...
    public static boolean isSWBTripleStore() {
        return persistenceType.equals(PRESIST_TYPE_SWBTRIPLESTORE);
    }
    ...
    public static boolean isSWBTripleStoreExt() {
        return persistenceType.equals(PRESIST_TYPE_SWBTRIPLESTOREEXT);
    }

    public static boolean isSWBTSMongo() {
        return persistenceType.equals(PRESIST_TYPE_SWBTSMONGO);
    }

    public static boolean isSWBTSMongoE() {
        return persistenceType.equals(PRESIST_TYPE_SWBTSMONGOE);
    }

    public static boolean isVirtuoso() {
        return persistenceType.equals(PRESIST_TYPE_VIRTUOSO);
    }

    public static boolean isSWBTSGen() {
        return persistenceType.equals(PRESIST_TYPE_SWBTSGEN);
    }

    public static boolean isSWBTSGemFire() {
        return persistenceType.equals(PRESIST_TYPE_SWBTSGEMFIRE);
    }
    ...
    public static boolean isSDB() {
        return persistenceType.equals(PRESIST_TYPE_SDB);
    }
    ...
    public static boolean isRDB() {
        return persistenceType.equals(PRESIST_TYPE_DEFAULT);
    }
    ...
    public static boolean isRemotePlatform() {
        return persistenceType.equals(PRESIST_TYPE_SWBREMOTETRIPLESTORE);
    }
