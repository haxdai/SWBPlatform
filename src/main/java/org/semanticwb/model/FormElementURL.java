...
public class FormElementURL {
    ...
    public String toString() {
        ...
        ret.append(SWBPlatform.getContextPath() + "/frmprocess")
                .append("?_swb_frmele=" + frmele.getSemanticObject().getEncodedURI());
        if (obj != null && obj.getURI() != null) {
            ...
            if (obj.getSemanticClass() != null) {
                ret.append("&_swb_cls=" + obj.getSemanticClass().getEncodedURI());
            }
        }
        ret.append("&_swb_prop=" + prop.getEncodedURI())
                .append("&_swb_urltp=" + URLEncoder.encode(urltype));

        if (codetype != null) {
            ret.append("&_swb_codetp=" + URLEncoder.encode(codetype));
        }
        if (mode != null) {
            ret.append("&_swb_mode=" + URLEncoder.encode(mode));
        }
        if (lang != null) {
            ret.append("&_swb_lang=" + URLEncoder.encode(lang));
        }
        if (contentType != null) {
            ret.append("&_swb_contentType=" + URLEncoder.encode(contentType));
        }
        if (characterEncoding != null) {
            ret.append("&_swb_characterEncoding=" + URLEncoder.encode(characterEncoding));
        }
        ...
        while (it.hasNext()) {
            ...
            if (val != null) {
                ret.append("&" + key + "=" + URLEncoder.encode(val));
            }
        }
        return ret.toString();
    }
